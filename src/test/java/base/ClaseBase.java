...
public class ClaseBase {
	...
	public void click(By locator, File routeFolder) throws InterruptedException, Exception {
		try {
			...
			snapShootScreen(routeFolder, locator, "Si");
			// ESPERAR 2 SEGUNDOS
			standByTime(2000);
	...
	// METODO PARA TRAER EL TEXTO DE UN ELEMENTO
	public String getText(By locator) throws InterruptedException, Exception {
		// IDENTIFICAR EL ELEMENTO Y DAMOS EL CLICK
		String textLocator = driver.findElement(locator).getText();
		// ESPERAR 2 SEGUNDOS
		return textLocator;
	}
	
	// METODO PARA VERIFICAR SI EL ELEMENTO ESTA HABILITADO
	public boolean isEnabled(By locator) {
		// IDENTIFICAMOS EL ELEMENTO Y VERIFICAMOS SI ESTA HABILITADO
		boolean enabled = driver.findElement(locator).isEnabled();
		return enabled;
	}
	
	// METODO PARA VERIFICAR SI EL ELEMENTO ESTA VISIBLE
	public boolean isDisplay(By locator) {
		// IDENTIFICAMOS EL ELEMENTO Y VERIFICAMOS SI ESTA VISIBLE
